...
class IQLAgent(DQNAgent):
    ...
    def estimate_advantage(self, ob_no, ac_na, re_n, next_ob_no, terminal_n,
        ...
        advantage = self.get_qvals(self.exploitation_critic, ob_no, action = ac_na) - self.get_qvals(self.exploitation_critic, ob_no, use_v=True)
        return advantage
        ### YOUR CODE END HERE ###
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        if (self.t > self.learning_starts
            ...
            actor_loss = - (self.awac_actor.log_prob(ob_no, ac_na) * (advantage/self.agent_params['awac_lambda']).exp()).mean()
            ### YOUR CODE END HERE ###
