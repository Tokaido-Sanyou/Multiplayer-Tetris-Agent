...
class DQNAgent(BaseAgent):
    ...
    def __init__(self,
        ...
        # Initialize networks
        self.q_network = DQNModel(action_space_size=action_space_size, **self.model_config).to(self.device)
        self.target_network = DQNModel(action_space_size=action_space_size, **self.model_config).to(self.device)
