...
# Change relative imports to module-based imports
try:
    from localMultiplayerTetris.dqn_adapter import board_props, enumerate_next_states
    ...
    try:
        ...
        # If still can't import, we'll handle this in the class
        pass
