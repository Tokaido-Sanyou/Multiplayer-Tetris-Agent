#!/usr/bin/env python3
"""
Enhanced DQN Training Script - Standalone Version

This script provides both single and vectorized environment training for the DQN agent.
It's designed to work properly with Python's module system without import issues.
...
Usage:
    python train_dqn.py --mode vectorized --num_episodes 10000 --num_envs 8
    python train_dqn.py --mode single --num_episodes 5000
    python train_dqn.py --checkpoint checkpoints/dqn_checkpoint_episode_5000.pt
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Train DQN agent on Tetris',
